...
for key in final_links:
    ...
    f = open("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/datosMOAReentrenados12/link" + str(i)+ ".arff", 'w')
...
for key in final_links:
    ...
    f = open("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/datosMOAReentrenados4/link" + str(i)+ ".arff", 'w')
    f.write("% Documento para utilizarse en Weka\n")
    f.write("@relation OLSR\n\n")
    f.write("@attribute " + "Link-4" + " numeric""\n")
    f.write("@attribute " + "Link-3" + " numeric""\n")
...
for key in final_links:
    ...
    f = open("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/datosMOAReentrenados3/link" + str(i)+ ".arff", 'w')
    f.write("% Documento para utilizarse en Weka\n")
    f.write("@relation OLSR\n\n")
    f.write("@attribute " + "Link-3" + " numeric""\n")
    f.write("@attribute " + "Link-2" + " numeric""\n")
...
for key in final_links:
    ...
    f = open("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/datosMOAReentrenados2/link" + str(i)+ ".arff", 'w')
    f.write("% Documento para utilizarse en Weka\n")
    f.write("@relation OLSR\n\n")
    f.write("@attribute " + "Link-2" + " numeric""\n")
    f.write("@attribute " + "Link-1" + " numeric""\n")
...
for key in final_links:
    ...
    f = open("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/datosMOAReentrenados1/link" + str(i)+ ".arff", 'w')
    f.write("% Documento para utilizarse en Weka\n")
    f.write("@relation OLSR\n\n")
    f.write("@attribute " + "Link-1" + " numeric""\n")
    f.write("@attribute " + "Link" + str(i)+ " numeric""\n")
