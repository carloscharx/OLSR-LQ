...
# Nuevo : quitar los de conjunto de entrenamiento constante de dia 1... hasta dia 6
final_links = {}
for key in variable_links:
    suma = 0.000
    max = 0.000
...
print("Tenemos un total de " + str(len(final_links)) + " después de eliminar enlaces de los que no hay suficientes datos para entrenar, y aquellos con conjunto de entrenamiento constante (Como se reentrena, días constantes)")
...
for key in final_links:
    ...
    f = open("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/datosWekaReentrenados/link" + str(i)+ ".arff", 'w')
